	 ...
	 <div id="topnav" class="f_r">
	     <ul>
		     <a href="#" target="_blank" id="topnav_current">首页</a>
			  ...
			  <a href="http://127.0.0.1/phptest/blog/admin/login.php" target="_blank">登录</a>
		  </ul>
	 </div>
  </header>
  <article>
	    ...
	    文章推荐
	     ...
	     <div class="blogs">
		  ...
		  <div class="blogs">
		      <figure>
			   ...
			   <ul>
			       <h3><a href="read.php?pid=<?php echo $blogs[1]['pid'];?>"><?php echo $blogs[1]['title'];?></a></h3>
				  <p><?php echo mb_substr(strip_tags($blogs[1]['content']),0,80);?> ......</p>
			     <p class="autor">
				    <span class="lm f_l">
					    <a href="/">个人博客</a>
					 </span>
	     ...
	     <div class="blogs">
		     <figure>
			   ...
			   <ul>
			     <h3><a href="read.php?pid=<?php echo $blogs[3]['pid'];?>"><?php echo $blogs[4]['title'];?></a></h3>
				  <p><?php echo mb_substr(strip_tags($blogs[3]['content']),0,80);?> ......</p>
			     <p class="autor">
				    <span class="lm f_l">
					    <a href="/">个人博客</a>
					 </span>
